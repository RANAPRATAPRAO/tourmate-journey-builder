    ...
    <div className="top-0 left-0 w-full h-full dark:bg-grey-800 bg-black dark:bg-grid-white/[0.2] bg-grid-black/[0.2] overflow-hidden">
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="relative w-4/5 h-4/5">
          ...
          />
      <h1 className="absolute top-1/2 left-20 transform -translate-y-1/2 text-white text-4xl font-bold">Where to Next ?</h1>

          {/* this is for the input  and Search Button */}
          <div className="absolute left-10 bottom-16 p-10">
            <form className="my-8">
